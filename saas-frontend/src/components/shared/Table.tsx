...
>(({ className, ...props }, ref) => (
  <div className="w-full overflow-auto rounded-xl border border-[var(--border-color)] bg-[var(--bg-surface)]">
    <table
      ref={ref}
...
>(({ className, ...props }, ref) => (
  <tr
    ref={ref}
    className={clsx(
      'border-b border-[var(--border-color)] transition-colors hover:bg-white/5 data-[state=selected]:bg-[var(--bg-elevated)]',
      className
    )}
    {...props}
  />
